    ...
    <div class="bg-white rounded-xl border border-gray-100">
        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-gray-50">
                ...
                <?php $__currentLoopData = $promo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr class="hover:bg-gray-50/60 transition">
                    <td class="px-5 py-4">
                        <p class="text-sm font-semibold text-gray-800"><?php echo e($pr['nama']); ?></p>
                        <p class="text-xs text-gray-400 mt-0.5"><?php echo e($pr['sub']); ?></p>
                    </td>
                    <td class="px-5 py-4">
                        <span class="text-xs font-bold tracking-widest px-3 py-1.5 rounded-md
                            <?php echo e($pr['aktif'] ? 'bg-emerald-50 text-emerald-700 border border-emerald-200' : 'bg-gray-100 text-gray-400 border border-gray-200'); ?>">
                            <?php echo e($pr['kode']); ?>

                        </span>
                    </td>
                    <td class="px-5 py-4">
                        <span class="text-sm text-gray-600"><?php echo e($pr['berlaku']); ?></span>
                    </td>
                    <td class="px-5 py-4">
                        <div class="flex items-center gap-2">
                            <div class="w-9 h-5 rounded-full flex items-center px-0.5 <?php echo e($pr['aktif'] ? 'bg-[#064E3B]' : 'bg-gray-200'); ?>">
                                <div class="w-4 h-4 bg-white rounded-full shadow <?php echo e($pr['aktif'] ? 'translate-x-4' : 'translate-x-0'); ?> transition"></div>
                            </div>
                            <span class="text-xs font-semibold <?php echo e($pr['aktif'] ? 'text-emerald-600' : 'text-gray-400'); ?>">
                                <?php echo e($pr['aktif'] ? 'Enable' : 'Disable'); ?>
