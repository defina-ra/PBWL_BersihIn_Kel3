...
<body class="min-h-screen flex">
  ...
  <div class="hidden lg:flex lg:w-1/2 relative left-panel">
    ...
    <div class="absolute bottom-0 left-0 right-0 p-10">
      ...
      <h2 class="text-white text-3xl font-extrabold leading-tight mb-3">
        Bergabung &<br>Rasakan Bedanya.
      </h2>
      <p class="text-green-100 text-sm leading-relaxed max-w-sm mb-8">
        Layanan kebersihan profesional untuk hunian yang lebih sehat dan nyaman. Daftar sekarang dan dapatkan layanan terbaik.
      </p>
      ...
      <p class="text-green-300 text-xs mt-6 tracking-widest uppercase">Terpercaya Sejak 2020</p>
    </div>
  </div>
  ...
  <div class="w-full lg:w-1/2 flex flex-col justify-between bg-white px-8 py-10 sm:px-16 overflow-y-auto">
    ...
    <div class="w-full max-w-sm mx-auto py-8">
      ...
      <div class="mb-5">
        ...
        <div class="relative">
          ...
          <input id="passwordInput" type="password" placeholder="Min. 8 karakter"
      ...
      <button class="w-full bg-[#064E3B] hover:bg-emerald-800 text-white font-bold py-3.5 rounded-xl text-sm transition mb-5 flex items-center justify-center gap-2">
        Daftar Sekarang
    ...
    <div class="text-center">
      ...
      <div class="flex justify-center gap-4 mt-2">
        <a href="#" class="text-xs text-gray-300 hover:text-gray-500">Kebijakan Privasi</a>
        <span class="text-gray-200">·</span>
        <a href="#" class="text-xs text-gray-300 hover:text-gray-500">Syarat & Ketentuan</a>
      </div>
    </div>
