    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            <div class="profile-card p-6 text-center">
                <div class="flex justify-center mb-4">
                    <div class="avatar-ring">
                        <img src="https://i.pravatar.cc/150?img=47" alt="Defina" id="avatarImg">
                ...
                <p class="font-bold text-gray-900 text-lg">Defina Rahma</p>
                <p class="text-gray-500 text-sm">definaaja@gmail.com</p>
                <div class="flex justify-center mt-2">
                    <span class="tier-badge">✦ Gold Member</span>
                </div>
                <p class="text-xs text-gray-400 mt-3">Bergabung sejak Januari 2024</p>

                
                <div class="flex gap-2 mt-4">
                    <div class="stat-pill">
                        <p class="text-lg font-black text-emerald-700">12</p>
                        <p class="text-xs text-gray-500">Pesanan</p>
                    </div>
                    <div class="stat-pill">
                        <p class="text-lg font-black text-emerald-700">4.9</p>
                        <p class="text-xs text-gray-500">Rating</p>
                    </div>
                    <div class="stat-pill">
                        <p class="text-lg font-black text-amber-500">1.2K</p>
                        <p class="text-xs text-gray-500">Poin</p>
                    </div>
                </div>

                <button onclick="document.getElementById('avatarInput').click()"
                        class="btn-outline w-full mt-4 text-sm">
                    Ganti Foto Profil
                </button>
            </div>
        ...
        <div class="lg:col-span-2 space-y-4">
                ...
                <div class="section-body">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" value="Defina Ramadhani" placeholder="Nama lengkap kamu">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Nama Panggilan</label>
                            <input type="text" class="form-input" value="Defina" placeholder="Nama panggilan">
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="email" class="form-input" value="definaaja@gmail.com" placeholder="Email aktif kamu">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="tel" class="form-input" value="+62 81234567890" placeholder="+62 8xx-xxxx-xxxx">
                            </div>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="form-group mb-0">
                            ...
                            <div class="input-with-icon">
                                <svg class="input-icon w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                                <input type="date" class="form-input" value="2003-05-12">
                            </div>
                        </div>
                        <div class="form-group mb-0">
            ...
            <div class="profile-card">
                ...
                <div class="section-body">
                    <div class="form-group">
                        ...
                        <textarea class="form-input" rows="2" placeholder="Jl. nama jalan, nomor, RT/RW...">Jl. Merdeka No. 10, Bandar Lampung</textarea>
                        <p class="text-xs text-gray-400 mt-1.5">📌 Alamat ini akan muncul otomatis saat kamu memesan layanan</p>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="form-group mb-0">
                            <label class="form-label">Kota</label>
                            <input type="text" class="form-input" value="Bandar Lampung" placeholder="Kota">
                        </div>
                        <div class="form-group mb-0">
                            <label class="form-label">Provinsi</label>
                            <input type="text" class="form-input" value="Lampung" placeholder="Provinsi">
                        </div>
                        <div class="form-group mb-0">
                            <label class="form-label">Kode Pos</label>
                            <input type="text" class="form-input" value="35131" placeholder="Kode pos" maxlength="5">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="form-group mb-0">
                            ...
                            <div class="input-with-icon relative">
                                ...
                                <input type="password" class="form-input" placeholder="••••••••" style="padding-right:36px" id="passLama">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="input-with-icon relative">
                                <svg class="input-icon w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z"/></svg>
                                <input type="password" class="form-input" placeholder="Min. 8 karakter" style="padding-right:36px" id="passBaru" oninput="checkStrength(this.value)">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="input-with-icon relative">
                                ...
                                <input type="password" class="form-input" placeholder="Ulangi password baru" style="padding-right:36px" id="passKonfirm">
            ...
            <div class="flex items-center justify-between flex-wrap gap-3">
                <button class="btn-danger-soft">Hapus Akun</button>
                <div class="flex gap-3">
                    <button class="btn-outline">Batal</button>
                    <button class="btn-primary" onclick="simpanPerubahan()">
...
<?php echo $__env->make('bersihin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\prak-web-lanjut-2407051023\PBWL_BersihIn_Kel3\laravel\resources\views/bersihin/customer/pengaturan.blade.php ENDPATH**/ ?>