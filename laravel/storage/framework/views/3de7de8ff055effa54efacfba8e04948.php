            ...
            <div class="profile-card p-6 text-center">
                <div class="flex justify-center mb-4">
                    <div class="avatar-ring">
                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($user->name)); ?>&background=dcfce7&color=064e3b&bold=true&size=150" alt="<?php echo e($user->name); ?>" id="avatarImg">
                ...
                <p class="font-bold text-gray-900 text-lg"><?php echo e($user->name); ?></p>
                <p class="text-gray-500 text-sm"><?php echo e($user->email); ?></p>
                <p class="text-xs text-gray-400 mt-3">Bergabung sejak <?php echo e(\Carbon\Carbon::parse($user->created_at)->translatedFormat('F Y')); ?></p>

                <div class="flex gap-2 mt-4">
                    <div class="stat-pill">
                        <p class="text-lg font-black text-emerald-700"><?php echo e(\DB::table('bookings')->where('user_id',$user->id)->count()); ?></p>
                        <p class="text-xs text-gray-500">Pesanan</p>
                    </div>
                    <div class="stat-pill">
                        <p class="text-lg font-black text-emerald-700"><?php echo e(\DB::table('bookings')->where('user_id',$user->id)->where('status','done')->count()); ?></p>
                ...
                <div class="section-body">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-input" value="<?php echo e(old('name', $user->name)); ?>" placeholder="Nama lengkap kamu">
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-with-icon">
                                ...
                                <input type="tel" name="phone" class="form-input" value="<?php echo e(old('phone', $user->phone ?? '')); ?>" placeholder="+62 8xx-xxxx-xxxx">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="input-with-icon">
                            ...
                            <input type="email" name="email" class="form-input" value="<?php echo e(old('email', $user->email)); ?>" placeholder="Email aktif kamu">
                        </div>
                    </div>
                </div>
            </div>
