                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50/60 cursor-pointer border-t border-gray-50"
                        ...
                        <td class="px-5 py-4">
                            ...
                            <p class="text-xs text-gray-400 mt-0.5"><?php echo e(\Carbon\Carbon::parse($item->created_at)->format('H:i')); ?> WIB</p>
                        </td>
                        <td class="px-5 py-4">
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50/60 border-t border-gray-50">
                        ...
                        <td class="px-5 py-4">
                            ...
                            <p class="text-xs text-gray-400 mt-0.5"><?php echo e($item->booking_time); ?></p>
                        </td>
                        <td class="px-5 py-4">
            ...
            <table class="w-full">
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50/60 border-t border-gray-50 cursor-pointer"
                        onclick="pilihPesanan(<?php echo e($item->booking_id); ?>, '<?php echo e($item->customer_name); ?>', '<?php echo e(number_format($item->amount, 0, ',', '.')); ?>', '<?php echo e($item->payment_method); ?>', <?php echo e($item->payment_id); ?>, '<?php echo e($item->payment_proof); ?>')">
                        <td class="px-5 py-4">
                            <p class="text-sm text-gray-700"><?php echo e(\Carbon\Carbon::parse($item->created_at)->format('d M Y')); ?></p>
                            <p class="text-xs text-gray-400 mt-0.5"><?php echo e(\Carbon\Carbon::parse($item->created_at)->format('H:i')); ?> WIB</p>
                        </td>
                        <td class="px-5 py-4">
                            <span class="text-sm font-bold text-[#064E3B]">#BRS-<?php echo e($item->booking_id); ?></span>
                        </td>
                        <td class="px-5 py-4">
                            <span class="text-sm text-gray-700"><?php echo e($item->customer_name); ?></span>
                        </td>
                        <td class="px-5 py-4">
                            <span class="text-xs font-semibold bg-green-50 text-green-700 px-2.5 py-1 rounded-lg"><?php echo e($item->service_name); ?></span>
                        </td>
                        <td class="px-5 py-4">
                            <span class="text-sm font-semibold text-gray-800">Rp <?php echo e(number_format($item->amount, 0, ',', '.')); ?></span>
                        </td>
                        <td class="px-5 py-4">
                            ...
                            <?php else: ?>
                            <span class="text-xs font-semibold text-gray-400 bg-gray-50 border border-gray-200 px-2.5 py-1 rounded-full"><?php echo e($item->payment_status); ?></span>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
