...
<div class="mb-6">
  <h1 class="text-2xl font-extrabold text-gray-900">Halo, <?php echo e($user->name); ?>! 👋</h1>
  <p class="text-gray-400 text-sm mt-1">Semangat bertugas hari ini. Kamu punya <span class="text-[#064E3B] font-bold"><?php echo e($sisaTugas); ?> tugas</span> yang menanti.</p>
</div>
...
<div class="grid grid-cols-3 gap-4 mb-6">
  <div class="bg-white rounded-2xl border border-gray-100 px-5 py-4 flex items-center justify-between">
    <div>
      ...
      <p class="text-3xl font-extrabold text-gray-900"><?php echo e($sisaTugas); ?></p>
    </div>
  ...
  <div class="bg-white rounded-2xl border border-gray-100 px-5 py-4 flex items-center justify-between">
    <div>
      ...
      <p class="text-3xl font-extrabold text-gray-900"><?php echo e($totalSelesai); ?></p>
    </div>
  ...
  <div class="bg-white rounded-2xl border border-gray-100 px-5 py-4 flex items-center justify-between">
    <div>
      ...
      <p class="text-3xl font-extrabold text-gray-900"><?php echo e($totalSelesai * 10); ?></p>
    </div>
...
<div class="grid grid-cols-2 gap-6 mb-6">
  ...
  <div class="bg-white rounded-2xl border border-gray-100 p-6">
    ...
    <?php if($tugasSelanjutnya): ?>
    <div class="space-y-4">
      <div>
        <p class="text-xs text-gray-400 uppercase tracking-wide font-semibold mb-1">Layanan</p>
        <p class="font-bold text-gray-900"><?php echo e($tugasSelanjutnya->service_name); ?></p>
      </div>
      <div class="grid grid-cols-2 gap-4">
        <div>
          ...
          <div class="flex items-center gap-1.5">
            ...
            <p class="font-semibold text-gray-800"><?php echo e($tugasSelanjutnya->customer_name); ?></p>
          </div>
        </div>
        <div>
          ...
          <div class="flex items-center gap-1.5">
            ...
            <p class="font-semibold text-gray-800"><?php echo e($tugasSelanjutnya->booking_time); ?></p>
          </div>
        </div>
      </div>
      <div>
        ...
        <div class="flex items-start gap-1.5">
          ...
          <p class="text-gray-700 text-sm"><?php echo e($tugasSelanjutnya->address); ?></p>
        </div>
      </div>
    </div>
    <?php else: ?>
    ...
    <div class="relative h-full min-h-64 bg-gray-100 flex items-center justify-center">
      ...
      <div class="relative z-10 flex flex-col items-center">
        ...
        <div class="mt-2 bg-white text-xs font-semibold text-gray-700 px-3 py-1.5 rounded-full shadow">
          <?php echo e($tugasSelanjutnya ? $tugasSelanjutnya->address : 'Tidak ada tugas'); ?>
  ...
  <div class="col-span-2 bg-white rounded-2xl border border-gray-100 p-6">
    ...
    <div class="border-l-4 border-[#064E3B] pl-4 bg-green-50/50 py-3 pr-4 rounded-r-xl">
      <p class="text-gray-600 text-sm italic leading-relaxed">
        "Pastikan membawa perlengkapan lengkap untuk layanan <?php echo e($tugasSelanjutnya->service_name); ?> di <?php echo e($tugasSelanjutnya->address); ?>."
      </p>
    </div>
    <?php else: ?>
...
<?php echo $__env->make('bersihin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\prak-web-lanjut-2407051023\PBWL_BersihIn_Kel3\laravel\resources\views/bersihin/petugas/dashboard.blade.php ENDPATH**/ ?>