<?php $__env->startSection('page-title', 'Layanan Kami'); ?>
<?php $__env->startSection('page-subtitle', 'Pilih layanan kebersihan sesuai kebutuhan kamu'); ?>
...
<div class="flex justify-between items-center mb-6">
    <p class="text-gray-400 text-sm"><?php echo e($layanan->count()); ?> layanan tersedia</p>
...
<div class="grid grid-cols-3 gap-5 mb-8">
    ...
    <div class="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-200 hover:-translate-y-1 flex flex-col">
        ...
        <!-- FOTO -->
        <div class="relative overflow-hidden" style="height:190px;background:<?php echo e($grad); ?>;">
            <img src="<?php echo e($foto); ?>"
                 alt="<?php echo e($l->service_name); ?>"
            ...
            <span class="absolute top-3 right-3 text-white text-xs font-bold px-3 py-1 rounded-full shadow-sm" style="background:rgba(0,0,0,0.45);">
                Rp <?php echo e(number_format($l->price, 0, ',', '.')); ?>
        ...
        <div class="p-5 flex flex-col flex-1">
            <h3 class="font-bold text-gray-900 text-base mb-1"><?php echo e($l->service_name); ?></h3>
            <p class="text-gray-500 text-sm leading-relaxed mb-4 flex-1"><?php echo e($l->description); ?></p>
            <a href="/bersihin/booking?service_id=<?php echo e($l->id); ?>"
...
<?php echo $__env->make('bersihin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\prak-web-lanjut-2407051023\PBWL_BersihIn_Kel3\laravel\resources\views/bersihin/customer/layanan.blade.php ENDPATH**/ ?>