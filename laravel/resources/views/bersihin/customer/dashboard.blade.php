...
<!-- GREETING -->
<div class="mb-6">
    <h1 class="text-2xl font-extrabold text-gray-900" style="font-family:'Sora',sans-serif;">Halo, {{ $user->name }}! 👋</h1>
...
<div class="grid grid-cols-3 gap-4 mb-6">
    <div class="stat-card">
        ...
        <div>
            ...
            <p class="text-3xl font-extrabold text-gray-900" style="font-family:'Sora',sans-serif;">{{ $totalPesanan }}</p>
        </div>
    </div>
...
<div class="card-section mb-6">
    <div class="p-6 border-b border-gray-100 flex justify-between items-start">
        <div>
            ...
            <p class="text-sm text-gray-400 mt-0.5">ID: <span class="font-mono text-xs bg-gray-100 px-2 py-0.5 rounded">#BRS-{{ $pesananAktif->id }}</span></p>
        </div>
        <span class="text-xs font-bold px-3 py-1.5 rounded-full" style="background:#dbeafe;color:#1d4ed8;">{{ strtoupper($pesananAktif->status) }}</span>
    </div>
    <div class="p-6">
        <div class="flex gap-4 mb-4">
            <div class="flex-1 bg-green-50 rounded-xl p-3 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm font-bold text-gray-800">{{ \Carbon\Carbon::parse($pesananAktif->booking_date)->format('d M Y') }}</p>
                </div>
            </div>
            <div class="flex-1 bg-blue-50 rounded-xl p-3 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm font-bold text-gray-800">{{ Str::limit($pesananAktif->address, 25) }}</p>
                </div>
            </div>
        </div>
